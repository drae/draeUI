...
local StyleDrae_Target = function(frame)
	...
	local level = DraeUI.CreateFontObject(frame.Health, DraeUI.config["general"].fontsize1, DraeUI["media"].font, "RIGHT",
		-5, 10)
	...
	-- Auras
	UF.AddBuffs(frame, "TOPLEFT", frame.Health, "BOTTOMLEFT", 0, -22, DraeUI.config["frames"].auras.maxTargetBuff or 8,
		DraeUI.config["frames"].auras.auraLrg, 8, "RIGHT", "DOWN")
	UF.AddDebuffs(frame, "TOPRIGHT", frame.Health, "BOTTOMRIGHT", 0, -22,
		DraeUI.config["frames"].auras.maxTargetDebuff or 6, DraeUI.config["frames"].auras.auraSml, 8, "LEFT", "DOWN")

	-- Castbar
	UF.CreateCastBar(frame, 220, 14, frame.Health, "BOTTOMLEFT", "TOPLEFT", 0, 15)
